...
void Board::Draw4LineStroke(int poz, int y, Color c)
{
	for (int i = poz; i < poz + 4; i++) {
		DrawCellStroke(i, y, c);
	}
}
...
void Board::DrawCellStroke(int x, int y, Color c)
{
	gfx.DrawRectPoints(xboard + xdim*x+2, yboard + ydim*y+2, xboard + xdim*(x + 1)-2, yboard + ydim*(y + 1)-2, c);
...
void Board::drawG(int x, int y, Color c)
{
	Draw4LineStroke(x,y,c);
	Draw4LineStroke(x,y + 5,c);
	for (int j = y + 1; j <= y + 4; j++) {
		DrawCellStroke(x, j, c);
	}
	DrawCellStroke(x + 2, y + 3, c);
	DrawCellStroke(x + 3, y + 3, c);
	DrawCellStroke(x + 3, y + 4, c);
	//DrawCellStroke(x + 4, y + 3, c);
}
